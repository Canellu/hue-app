...
NOTE – These pages are about version 1 of our Hue API, but we currently have a version 2 available. We recommend to use the V2 API where possible, to minimize the need for migration later on. You can find the documentation on [Hue API V2](https://developers.meethue.com/develop/hue-api-v2/).
