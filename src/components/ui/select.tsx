...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex w-fit items-center justify-between gap-2 border border-foreground/12 bg-popover dark:border-foreground/8 py-2 pr-3.5 pl-4.5 text-sm whitespace-nowrap text-popover-foreground transition-colors dark:bg-[oklch(0.25_0_0)] outline-none select-none focus-visible:ring-3 focus-visible:ring-ring/50 disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 data-placeholder:text-muted-foreground data-[size=default]:h-11 data-[size=default]:rounded-2xl data-[size=default]:text-[15px] data-[size=sm]:h-9 data-[size=sm]:rounded-xl data-[size=xl]:h-12 data-[size=xl]:rounded-2xl data-[size=xl]:pr-4 data-[size=xl]:pl-5 data-[size=xl]:text-base *:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center *:data-[slot=select-value]:gap-2 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-5",
        className
      )}
      {...props}
    >
